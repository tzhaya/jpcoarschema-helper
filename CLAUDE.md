...
「ビルド」「テスト」に相当する検証は、**Mermaid 構文が GitHub で描画されること**と、**内部リンク切れがないこと**の目視確認です。CI 化は ROADMAP フェーズ2で予定されています。
...
プロパティを追加したとき、または状態を変更したときは、次の一覧も更新してください。現状は手動の二重メンテナンスであり、一元化は ROADMAP #7 で予定されています。

- [README.md](README.md) のフローチャート一覧表
- [decision-trees/README.md](decision-trees/README.md) の一覧表
