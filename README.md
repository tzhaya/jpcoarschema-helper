...
JPCOARスキーマ 2.0 の各項目を初心者が迷わず入力できるよう、FAO の [LODE-BD 3.0](https://doi.org/10.4060/cb2209en) の決定木方式にならって作成したガイド集です。
...
[reference/](reference/) に、各決定木が典拠とする資料を収録しています。
